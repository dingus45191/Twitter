    ...
    <div class="px-5 py-3 border-b-8 border-lighter flex">
      ...
      <form class="w-full px-4 relative">
        ...
        <div class="flex items-center">
             <i class=" far-fa-image    text-lg text-blue mx-6"></i>
             <i class=" fas-fa-film     text-lg text-blue mx-6"></i>
             <i class=" far-fa-chart-bar text-lg text-blue mx-6"></i>
             <i class=" far-fa-smile    text-lg text-blue mx-6"></i>
        </div>
      </form>
    </div>
   </div> 
